<footer>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark navbar-custom-height">
        ...
        <div class = "row align-items-center w-100 h-100 d-none d-sm-flex">
            <div class = "col-6 text-center">© 2025 MercaSwapp - Grupo 6</div>
            <div class = "col-6 text-center">
                <a href="<?= RUTA_APP ?>/view/contacto_pantalla.php">Nuestro equipo</a> | 
                <a href="<?= RUTA_APP ?>/view/planificacion_pantalla.php">Nuestra planificacion</a>
            </div>
        </div>
